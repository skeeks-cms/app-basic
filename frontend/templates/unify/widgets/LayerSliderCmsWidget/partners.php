...
<div id="layerslider" style="width: 100%; height: 500px; margin: 0px auto;">
    ...
    <div class="ls-slide" data-ls="slidedelay:6500;transition2d:25;">
        ...
        <span class="ls-s-1" style="
            ...
            durationout : 500;
        ">
            Партнерская программа SkeekS CMS
        </span>

        <img class="ls-l" src="/img/slider/filter-partner.png" style="top: 80px; left: 30%;" data-ls="offsetxin:left; durationin:500; delayin:900; fadein:false; offsetxout:left; durationout:1000; fadeout:false;" alt="">
...
<!--
        ...
        <span class="ls-s-2" style=" color: #fff; font-weight: 200; font-size: 22px; top:230px; left: 620px; slidedirection : right; slideoutdirection : top; delayin : 1100; durationin : 1000; durationout : 1500; ">
            <a href="/dokumentatsiya" style="color: #ffffff; text-decoration: underline;">Документация</a>
        </span>-->

        <a class="btn-u btn-u-lg btn-u-orange ls-l-1" href="/partnerstvo/stat-partnerom" target="_blank" style=" padding: 9px 20px; font-size:25px; top:340px; left: 590px; slidedirection : bottom; slideoutdirection : top; durationin : 3500; durationout : 2500; delayin : 1000; ">
